...
import eu.indiewalkabout.fridgemanager.core.domain.navigation.NavigationScreenConstants.HOME_SCREEN
...
sealed class AppDestinationRoutes(var name:String, var route:String) {
    ...
    object HomeScreen : AppDestinationRoutes("HomeScreen", HOME_SCREEN )
