 ...
 * ---------------------------------------------------------------------------------------------
 */
class FoodListActivity : AppCompatActivity(), FoodListAdapter.ItemClickListener, OnFABMenuSelectedListener {

    // Views ref
    private lateinit var foodsListToolbar: Toolbar
    ...
    private lateinit var foodlistType: String
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mAdView.loadAd(ConsentSDK.getAdRequest(this@FoodListActivity))
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == android.R.id.home) {
            ...
            val guess = GenericUtility.randRange_ApiCheck(1, 10)
            if (guess <= 4) {
                showInterstitialAd()
            }
    ...
    companion object {
        ...
        // expiring food flag
        val FOOD_EXPIRING = "ExpiringFood"

        // expiring food Today flag
        val FOOD_EXPIRING_TODAY = "ExpiringFoodToday"

        // saved food flag
        val FOOD_SAVED = "SavedFood"

        // dead food flag
        val FOOD_DEAD = "DeadFood"
    }
