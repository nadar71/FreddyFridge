...
class MainActivity : AppCompatActivity(), FoodListAdapter.ItemClickListener, OnFABMenuSelectedListener {
    ...
    private var helpBtn: ImageView? = null
    ...
    override fun onStart() {
        ...
        if (checkConsentActive == true) {
            ...
            consentObjReference = ConsentSDK.Builder(this)
            ...
            consentObjReference!!.checkConsent(object : ConsentSDK.ConsentCallback() {
                override fun onResult(isRequestLocationInEeaOrUnknown: Boolean) {
                    ...
                    mAdView!!.loadAd(ConsentSDK.getAdRequest(this@MainActivity))
                }
            })
    ...
    private fun initRecycleView() {
        ...
        // retrieve myApplication context for viewmodel
        // myApplication = (Application) getApplicationContext();
    ...
    private fun retrieveFoodExpiringToday() {
        ...
        foods!!.observe(this, Observer { foodEntries ->
            ...
            foodListAdapter!!.foodEntries = foodEntries as MutableList<FoodEntry>?
    ...
    companion object {
        ...
        private val NUM_MAX_OPENINGS = 2
