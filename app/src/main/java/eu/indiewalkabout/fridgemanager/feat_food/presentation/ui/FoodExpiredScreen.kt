...
fun FoodExpiredScreen(
    ...
    selectedDestination: AppDestination = AppDestination.Expired,
    ...
    TopLevelScreenScaffold(
        ...
        onNewItemClicked = { foodExpiredViewModel.setBottomSheetVisible(true) },
        isBottomSheetVisible = uiState.isBottomSheetVisible,
        onBottomSheetDismiss = { foodExpiredViewModel.setBottomSheetVisible(false) },
