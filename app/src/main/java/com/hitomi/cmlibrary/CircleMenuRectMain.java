...
/**
 * Circle submenu but main menu button rectangular: experiment....
 */

public class CircleMenuRectMain extends View {
    ...
    public CircleMenuRectMain(Context context) {
        this(context, null);
        Log.d("CircleMenu", "CircleMenu 1st constructor");

    }

    public CircleMenuRectMain(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        Log.d("CircleMenu", "CircleMenu 2nd constructor");
    }

    public CircleMenuRectMain(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        status = STATUS_MENU_CLOSED;
        Log.d("CircleMenu", "CircleMenu 3rd constructor");
    ...
    /**
     * Disegna un percorso circolare attorno al sottomenu circostante
     *
     * @param canvas
     */
    ...
    /**
     * Disegna l'icona quando il sottomenu viene ruotato
     *
     * @param canvas
     */
    ...
    /**
     * Disegna il percorso della traccia quando viene ruotato l'elemento del sottomenu
     *
     * @param canvas
     */
    ...
    /**
     * Disegna i pulsanti degli elementi del sottomenu circostanti
     *
     * @param canvas
     */
    ...
    /**
     * Disegna l'icona della voce del sottomenu
     *
     * @param canvas
     * @param centerX
     * @param centerY
    ...
    /**
     * Disegna il pulsante di interruttore del menu centrale
     *
     * @param canvas
     */
    private void drawMainMenu(Canvas canvas) {
        ...
        if (status == STATUS_MENU_CLOSE) {
            // Il pulsante centrale del menu principale esegue uno zoom al doppio della velocità
            realFraction = (1 - fraction * 2) == 0 ? 0 : (1 - fraction * 2);
            centerMenuRadius = partSize * realFraction;
        } else if (status == STATUS_MENU_CLOSE_CLEAR) {
            // Il pulsante centrale del menu principale si espande a quattro volte la velocità
        ...
        Rect rectMenuIcon = new Rect((int)((screenW-rectW)*0.5), (int)((screenH-rectH)*0.5), rectW, rectH);
        canvas.drawRect(rectMenuIcon,oPaint);
        drawMainMenuIcon(canvas);
    }


    /**
     * Diegna l'icona nel pulsante del main menu
     * @param canvas
     */
    ...
    /**
     * Disegna l'ombreggiatura del menu
     *
     * @param canvas
     * @param centerX
     * @param centerY
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (index == 0) { // Cliccando sul pulsante nel mezzo
                ...
                } else { // Cliccando sul pulsante dell'oggetto sottomenu circostante
    ...
    /**
     * Ottieni il colore del pulsante premuto
     *
     * @param menuIndex
     * @param depth     L'intervallo di valori è [0, 1]. Più grande è il valore, più scuro è il colore.
     * @return
     */
    ...
    /**
     * Effetti animati utilizzati per completare la scomparsa dell'anello nella vista <br/>
     * <p>
     * Regola il valore alfa del colore in base alla frazione
     *
     * @param color   Il colore del valore alfa regolato
     * @param reverse true : Regolato da opaco a trasparente, altrimenti invertito
     * @return
     */
    private int calcAlphaColor(int color, boolean reverse) {
        int alpha;
        if (reverse) { // Da opaco a trasparente
            alpha = (int) (255 * (1.f - fraction));
        } else { // Da trasparente a opaco
    ...
    /**
     * Avvia l'animazione del menu aperto
     */
    ...
    /**
     * Disattiva l'animazione del menu </br>
     * <p>L'animazione del menu Chiudi è divisa in tre parti
     </p>
     * <ur>
     * <li>Seleziona la voce di menu per ruotare di una settimana</li>
     * <li>La traiettoria del loop scompare</li>
     * <li>Rotazione del pulsante del menu principale</li>
     * </ur>
     */
    private void startCloseMeunAnima() {
        // Seleziona la voce di menu per ruotare un driver di animazione di una settimana
        ...
        aroundAnima.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                fraction = valueAnimator.getAnimatedFraction();
                // L'icona del menu principale centra lo zoom al doppio della velocità
        ...
        // Unità anulare di animazione per la scomparsa della diffusione di diffusione
        ...
        // Driver di animazione per la rotazione del menu principale
    ...
    /**
     * Ottieni il pulsante del menu attualmente selezionato <br/>
     * Il menu centrale è indicato da 0 e il menu circostante conta 1 ~ 5 in senso orario direttamente sopra.
     *
     * @param x
     * @param y
     * @return
    ...
    /**
     * Imposta il colore di sfondo del menu principale, nonché l'icona che si apre / si chiude
     *
     * @param mainMenuColor Colore di sfondo del menu principale
     * @param openMenuRes   Icona di menu aperto, Formato risorse
     * @param closeMenuRes  Icona di chiusura del menu, formato della risorsa
     * @return
     */
    public CircleMenuRectMain setMainMenu(int mainMenuColor, int openMenuRes, int closeMenuRes) {
     ...
     *
     * @param mainMenuColor   Colore di sfondo del menu principale
     * @param openMenuBitmap  Icona di menu aperto, formato bitmap
     * @param closeMenuBitmap Icona di chiusura menu, formato bitmap
     * @return
     */
    public CircleMenuRectMain setMainMenu(int mainMenuColor, Bitmap openMenuBitmap, Bitmap closeMenuBitmap) {
     ...
     *
     * @param mainMenuColor     Colore di sfondo del menu principale
     * @param openMenuDrawable  Icona di menu aperto, formato Drawable
     * @param closeMenuDrawable Icona di chiusura menu, formato Drawable
     * @return
     */
    public CircleMenuRectMain setMainMenu(int mainMenuColor, Drawable openMenuDrawable, Drawable closeMenuDrawable) {
    ...
    /**
     * Aggiungi una voce di sottomenu, compreso il colore di sfondo del sottomenu e l'icona
     *
     * @param menuColor Colore di sfondo del sottomenu
     * @param menuRes   Icona del sottomenu, formato della risorsa
     * @return
     */
    public CircleMenuRectMain addSubMenu(int menuColor, int menuRes) {
     ...
     *
     * @param menuColor  Colore di sfondo del sottomenu
     * @param menuBitmap Icona del sottomenu, formato bitmap
     * @return
     */
    public CircleMenuRectMain addSubMenu(int menuColor, Bitmap menuBitmap) {
        if (subMenuColorList.size() < MAX_SUBMENU_NUM && subMenuDrawableList.size() < MAX_SUBMENU_NUM) {
            subMenuColorList.add(menuColor);
     ...
     *
     * @param menuColor    Colore di sfondo del sottomenu
     * @param menuDrawable Icona del sottomenu, formato disegnabile
     * @return
     */
    public CircleMenuRectMain addSubMenu(int menuColor, Drawable menuDrawable) {
        if (subMenuColorList.size() < MAX_SUBMENU_NUM && subMenuDrawableList.size() < MAX_SUBMENU_NUM) {
            subMenuColorList.add(menuColor);
    ...
    public CircleMenuRectMain setOnMenuSelectedListener(OnMenuSelectedListener listener) {
        this.onMenuSelectedListener = listener;
        return this;
    }

    public CircleMenuRectMain setOnMenuStatusChangeListener(OnMenuStatusChangeListener listener) {
